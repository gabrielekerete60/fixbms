    ...
    const allLinks = [
      ...
      },
      {
        icon: Package, label: "Inventory", roles: ['Manager', 'Supervisor', 'Baker', 'Storekeeper', 'Accountant', 'Delivery Staff', 'Showroom Staff', 'Developer'], sublinks: [
          ...
          { href: "/dashboard/inventory/recipes", label: "Recipes & Production", icon: ClipboardList, roles: ['Manager', 'Supervisor', 'Storekeeper', 'Baker', 'Developer'] },
          ...
          { href: "/dashboard/inventory/waste-logs", label: "Waste Logs", icon: Trash2, roles: ['Manager', 'Supervisor', 'Storekeeper', 'Developer'] },
        ]
      },
      {
