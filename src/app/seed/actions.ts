...
const seedData = {
  ...
  transfers: [
      // Completed, Fully Paid (Not Owing)
      { id: "tsr_1_paid", from_staff_id: "100001", from_staff_name: "Chris Manager", to_staff_id: "400005", to_staff_name: "Akan Staff", items: [{ productId: "prod_1", productName: "Family Loaf", quantity: 20 }], date: daysAgo(5), status: 'completed', is_sales_run: true, notes: "Morning sales run to Lekki - Paid" },
      { id: "tsr_2_paid", from_staff_id: "100001", from_staff_name: "Chris Manager", to_staff_id: "400005", to_staff_name: "Akan Staff", items: [{ productId: "prod_5", productName: "Coca-Cola (50cl)", quantity: 24 }], date: daysAgo(4), status: 'completed', is_sales_run: true, notes: "Drinks for VI - Paid" },
      // Completed, Owing
